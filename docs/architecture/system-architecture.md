...
The active pointer selects schema-6.1 overlay `2026-08-07.2`. The repository validates its six TFC
payloads and checksum-bound schema-5.2 base `2026-08-07.1`, then exposes one joined in-memory
...
The active overlay is `2026-08-07.2`; its base contains 91 countries, 388 frozen urban centres and
