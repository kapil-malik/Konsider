...
| `2026-07-24.1` | Active stable 91-country Phase 2D release. | [Report](2026-07-24.1.md) |
...
`data/releases/active.json` currently selects `2026-07-24.1`. Historical releases are not current
