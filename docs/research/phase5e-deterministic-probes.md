...
Phase 5E ran the Phase 5D research framework against the exact approved live sources for C08, C11,
...
`data/reports/feasibility-probes/phase5e-deterministic-2026-07-26/report.md`. Its adjacent JSON, CSV,
country-status matrix, artifact inventory, replay evidence, and manifest are the authoritative
machine-readable outputs.

## Measured results

| Criterion | Valid | Missing | Stale | Invalid | Threshold | Phase 5E recommendation |
| --- | ---: | ---: | ---: | ---: | --- | --- |
