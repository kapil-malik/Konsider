# Konsider Phase 3F — Criteria Portfolio and Guardrail Decision

**Status:** Approved by user for Phase 3G execution
**Evidence cutoff:** `main@5215a28`
**Date:** 26 July 2026
**Scope:** Criteria portfolio, publication/readiness guardrails, fallback policy, and Phase 3G implementation order
...
Phase 3 has produced enough evidence to expand Konsider meaningfully, but not enough to force every important relocation question into a single national score.
...
7. Target **13 enabled criteria** for the mature Phase 3 portfolio, with a possible fourteenth if C71 proves sufficiently discriminating.
...
10. Do not start full Phase 3G implementation for unprobed candidates. Complete the final four probes first, then implement in the order defined in Section 12.
...
- Phase 3A research framework and 84-criterion classification
- Phase 3B screening of all 84 candidates
- Phase 3C deep-research batches 1–3
- Phase 3D deterministic feasibility-probe framework
- Phase 3E exact-source online probes and offline replay
...
The latest Phase 3E run measured seven exact candidates:

| Criterion | Valid | Full 91 | Licence | Replay | Phase 3E recommendation |
| --- | ---: | --- | --- | --- | --- |
...
Phase 3C estimates are useful for selecting probes. Phase 3E measured results govern production decisions where they exist.
...
### 4.2 Approve for Phase 3G production implementation
...
Combined C11 and C08 activation leaves 85/91 countries based on the measured non-valid-country union. This remains above the Phase 3 threshold.
...
Phase 3C found full coverage plausible from the WHO Global Health Expenditure Database, but exact stable-91 coverage and licence capture were not measured.
...
Phase 3C measured 91/91 availability in INFORM for the proposed hazard subset. Phase 3E did not run the deterministic exact-source probe.
...
**Proposed rule:** After the first successful Phase 3G release:
...
## 12. Phase 3G implementation order

### 12.1 Phase 3G-0 — Complete the final evidence gap

Before production implementation, run deterministic Phase 3E-style probes for:
...
### 12.2 Phase 3G-1 — Low-risk globally complete additions
...
### 12.3 Phase 3G-2 — Infrastructure clarification
...
### 12.4 Phase 3G-3 — Experimental global additions
...
### 12.5 Phase 3G-4 — Conditional complete-case capability
...
### 12.6 Phase 3G-5 — Optional final additions
...
Recommended first mature Phase 3 release:
...
## 13. Phase 3G acceptance criteria
...
Proceed with Phase 3G, but in two evidence levels:
