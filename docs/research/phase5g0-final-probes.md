# Phase 5G-0 final source probes

Status: completed 2026-07-26; non-publishing research

These probes tested the four unresolved Phase 5F candidates against exact official distributions.
...
`data/reports/feasibility-probes/phase5g0-2026-07-26-*-online/` and matching `*-replay/`
directories. Probe definitions are under `data/research/phase5g0/`. These outputs do not modify
