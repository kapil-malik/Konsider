...
No locality-scoped criterion has yet been production-onboarded. C66 completed
source and licensing exploration in Phase 5G but is held at the construct gate.
The other 44 criteria retain their Phase 5A dispositions.

## Complete not-onboarded inventory

| Current queue | Count | Criterion IDs | Next action |
| --- | ---: | --- | --- |
| First wave, held | 1 | C66 | Obtain authoritative JRC clarification of `CL_UTC_T32_2020` unit and urban-centre aggregation, then rerun all Phase 5G gates |
...
| **Total not onboarded** | **45** | **All original Phase 3 criteria** | Track through Phase 5 closure and later roadmap work |
