...
Phase 5 expanded Konsider's evidence base while preserving the stable 91-country universe,
...
| Stage | Scope | Outcome |
| --- | ---: | --- |
| Phase 5A framework | 84 candidate criteria | Established authority, licensing, comparability, coverage, freshness, granularity, scoring, and operational gates. |
| Phase 5B lightweight screen | 84/84 | Retained 42 for prioritized deeper research; classified all 84 by feasibility, natural granularity, and priority. |
| Phase 5C deep research | 45 unique criteria in three 15-item batches | Seven deterministic probe candidates, 15 conditional/experimental candidates, 20 deferrals, and three rejections at the batch-decision stage. |
| Phase 5D framework proof | Two fixture-backed examples | Proved country mapping, explicit missing outcomes, raw capture, deterministic reporting, and offline replay without publication. |
| Phase 5E measured probes | Seven live candidates | All passed the 82/91 research threshold; four were production candidates, two experimental, and one reserve. |
| Phase 5F portfolio decision | Consolidated 5A–5E evidence | Approved the portfolio guardrails and a staged implementation order. |
| Phase 5G-0 final probes | Four unresolved candidates | Three exact live probes completed; one source lacked a stable machine archive. None was promoted in 5G-1. |
| Phase 5G-1 production | Three globally complete candidates | Added political stability, rule of law, and established immigrant presence at 91/91. |
...
The other 39 candidates retain their Phase 5B screening rows. They were not silently rejected:
...
Phase 5A and 5B used a funnel rather than treating all 84 candidates as equally expensive:
...
further research; it was not automatic production approval. The 5G-1 publication retained 91/91
coverage for every enabled criterion.

## Sources probed

Phase 5D used schema-faithful fixture examples for World Bank JSON and ILOSTAT CSV. These proved the
framework only and were never treated as live source evidence.

Ten candidates received exact live source probes:

| Candidate construct | Exact publisher/distribution family | Verified valid coverage | Final Phase 5 disposition |
| --- | --- | ---: | --- |
...
- Other researched deferrals remain in the three Phase 5C batch reports; lack of promotion is not
...
- The enabled portfolio is eight, below the aspirational mature target of roughly 10–15; Phase 5
...
- [Phase 5A framework](../../konsider_phase5a/phase5a_framework.md)
- [Phase 5B screening](../../konsider_phase5b/phase5b_screening.md)
- [Phase 5C Batch 1](../../konsider_phase5c_batch1/phase5c_batch1.md)
- [Phase 5C Batch 2](../../konsider_phase5c_batch2/phase5c_batch2.md)
- [Phase 5C Batch 3](../../konsider_phase5c_batch3/phase5c_batch3.md)
- [Phase 5D framework proof](phase5d-feasibility-probes.md)
- [Phase 5E measured probes](phase5e-deterministic-probes.md)
- [Approved Phase 5F decision](konsider_phase5f_portfolio_decision.md)
- [Phase 5G-0 final probes](phase5g0-final-probes.md)
...
The Phase 5H documentation update passed:
