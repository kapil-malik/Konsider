# Phase 3D feasibility probes

Phase 3D introduces a small, deterministic framework for testing whether a
...
separate Phase 3C evidence review is required before making a coverage claim.
...
python -m konsider.research.feasibility_probe `
  --definition data/research/phase3d/c30-world-bank.json `
  --run-id phase3d-c30-fixture `
  --mode fixture `
  --fixture tests/fixtures/phase3d/c30-world-bank.json
```

```powershell
python -m konsider.research.feasibility_probe `
  --definition data/research/phase3d/c11-ilostat.json `
  --run-id phase3d-c11-fixture `
  --mode fixture `
  --fixture tests/fixtures/phase3d/c11-unemployment.csv `
  --fixture tests/fixtures/phase3d/c11-employment.csv `
  --fixture tests/fixtures/phase3d/c11-participation.csv
```

To rebuild the deterministic synthetic fixtures:

```powershell
python scripts/build_phase3d_fixtures.py
```
...
python -m konsider.research.feasibility_probe `
  ...
  --mode offline `
  --artifacts data/reports/feasibility-probes/phase3d-c30-fixture/raw-artifacts.json
```
...
1. Add a definition under `data/research/phase3d/`.
