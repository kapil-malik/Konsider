...
Active release: `2026-08-08.2` (ranking base `2026-08-08.1`)

Konsider exposes one structured API over the schema-current immutable snapshot selected by
`data/releases/active.json`. Active schema-6.1 overlay `2026-08-08.2` binds the TFC evidence and
checksum-identifies schema-5.2 ranking/OFC base `2026-08-08.1`. The generated
