# Konsider Phase 5C — Batch 2 source-feasibility research
...
Proceed to deterministic Phase 5E probes for **C29, C48, C49**. Run conditional experimental probes for **C34, C05, C16, C26**. Defer **C38, C35, C36, C15, C13, C14, C22** to profile, occupation, city, or legal modules. Reject **C19** as a scored criterion under the identified source methodology.
...
1. **C29 — Currency and macroeconomic stability** (DETERMINISTIC): Proceed to a deterministic Phase 5E probe using pinned 2020-2024 observations and explicit currency-break handling.
2. **C48 — Political stability and civil peace** (DETERMINISTIC): Proceed to a deterministic Phase 5E probe on the 2025-revision aggregate and its uncertainty fields.
3. **C49 — Rule of law and institutional trust** (DETERMINISTIC): Proceed to a deterministic Phase 5E probe after narrowing the label to Rule of Law and checking overlap with the active catalog.
4. **C34 — Citizenship accessibility** (CONDITIONAL): Run an experimental Phase 5E probe on the exact v3 archive, stable-91 mapping and a deliberately narrow naturalisation-rule subset.
5. **C05 — Research and innovation ecosystem** (CONDITIONAL): Run a conditional Phase 5E probe to measure stable-91 coverage, capture the exact data licence and compare overall/output-only variants.
6. **C26 — Healthcare affordability** (CONDITIONAL): Run a conditional Phase 5E probe for stable-91 recency and licensing capture; keep the criterion explicitly labelled financial-protection proxy.
7. **C16 — Entrepreneurship and startup opportunity** (CONDITIONAL): Run only a conditional Phase 5E recovery probe. The measured 79/91 result misses the 82-country threshold before partial-geography exclusions.
...
Defer to a later profile/legal pathway module. A Phase 5E national criterion probe would test the wrong unit of analysis.
...
- **ESTIMATED:** No current authoritative global profession-by-origin licensing dataset was verified. — Phase 5C Batch 2 source search
...
Run an experimental Phase 5E probe on the exact v3 archive, stable-91 mapping and a deliberately narrow naturalisation-rule subset.
...
Run a conditional Phase 5E probe to measure stable-91 coverage, capture the exact data licence and compare overall/output-only variants.
...
- **ESTIMATED:** The exact stable-91 intersection was not measured in Batch 2. — Phase 5C Batch 2
...
- **ESTIMATED:** No globally comparable vacancy series at engineering-specialty and city level was verified. — Phase 5C Batch 2 source search
...
- **ESTIMATED:** No authoritative global city vacancy source with production-compatible reuse was verified. — Phase 5C Batch 2 source search
...
- Measured current coverage is below the Phase 5A minimum of 82; some available country values also cover partial geography.
...
Run only a conditional Phase 5E recovery probe. The measured 79/91 result misses the 82-country threshold before partial-geography exclusions.
...
- **MEASURED:** The exact 2022-2024 WDI query returned current observations for 79/91 stable countries; 12 were missing. — konsider_phase5c_batch2/world_bank_coverage_measurements.json
...
Run a conditional Phase 5E probe for stable-91 recency and licensing capture; keep the criterion explicitly labelled financial-protection proxy.
...
Proceed to a deterministic Phase 5E probe using pinned 2020-2024 observations and explicit currency-break handling.
...
- **MEASURED:** The stated two-component recency rule produced a measured 91/91 stable-country intersection. — konsider_phase5c_batch2/world_bank_coverage_measurements.json
...
Proceed to a deterministic Phase 5E probe on the 2025-revision aggregate and its uncertainty fields.
...
- **MEASURED:** The exact 2024 GOV_WGI_PV_EST API query returned 91/91 stable countries. — konsider_phase5c_batch2/world_bank_coverage_measurements.json
...
Proceed to a deterministic Phase 5E probe after narrowing the label to Rule of Law and checking overlap with the active catalog.
...
- **MEASURED:** The exact 2024 GOV_WGI_RL_EST API query returned 91/91 stable countries. — konsider_phase5c_batch2/world_bank_coverage_measurements.json
