...
const specs = [
  {
    ...
    recommendation: "Defer to a later profile/legal pathway module. A Phase 5E national criterion probe would test the wrong unit of analysis.",
    ...
    evidence: [
      ...
      evidence("No current authoritative global profession-by-origin licensing dataset was verified.", "Phase 5C Batch 2 source search", "ESTIMATED"),
    ],
  },
  {
    rank: 2,
  ...
  },
  {
    ...
    recommendation: "Run an experimental Phase 5E probe on the exact v3 archive, stable-91 mapping and a deliberately narrow naturalisation-rule subset.",
  ...
  },
  {
    ...
    recommendation: "Run a conditional Phase 5E probe to measure stable-91 coverage, capture the exact data licence and compare overall/output-only variants.",
    ...
    evidence: [
      ...
      evidence("The exact stable-91 intersection was not measured in Batch 2.", "Phase 5C Batch 2", "ESTIMATED"),
    ],
  },
  {
    rank: 6,
    ...
    evidence: [
      ...
      evidence("No globally comparable vacancy series at engineering-specialty and city level was verified.", "Phase 5C Batch 2 source search", "ESTIMATED"),
    ],
  },
  {
    rank: 7,
  ...
  },
  {
    ...
    evidence: [
      ...
      evidence("No authoritative global city vacancy source with production-compatible reuse was verified.", "Phase 5C Batch 2 source search", "ESTIMATED"),
    ],
  },
  {
    rank: 9,
    ...
    coverage: {
      ...
      rationale: "Measured current coverage is below the Phase 5A minimum of 82; some available country values also cover partial geography.",
    },
    sources: [
    ...
    recommendation: "Run only a conditional Phase 5E recovery probe. The measured 79/91 result misses the 82-country threshold before partial-geography exclusions.",
    ...
    evidence: [
      ...
      evidence("The exact 2022-2024 WDI query returned current observations for 79/91 stable countries; 12 were missing.", "konsider_phase5c_batch2/world_bank_coverage_measurements.json", "MEASURED"),
    ],
  },
  {
    rank: 10,
  ...
  },
  {
    ...
    recommendation: "Run a conditional Phase 5E probe for stable-91 recency and licensing capture; keep the criterion explicitly labelled financial-protection proxy.",
  ...
  },
  {
    ...
    recommendation: "Proceed to a deterministic Phase 5E probe using pinned 2020-2024 observations and explicit currency-break handling.",
    ...
    evidence: [
      ...
      evidence("The stated two-component recency rule produced a measured 91/91 stable-country intersection.", "konsider_phase5c_batch2/world_bank_coverage_measurements.json", "MEASURED"),
    ],
  },
  {
    rank: 14,
    ...
    recommendation: "Proceed to a deterministic Phase 5E probe on the 2025-revision aggregate and its uncertainty fields.",
    ...
    evidence: [
      ...
      evidence("The exact 2024 GOV_WGI_PV_EST API query returned 91/91 stable countries.", "konsider_phase5c_batch2/world_bank_coverage_measurements.json", "MEASURED"),
    ],
  },
  {
    rank: 15,
    ...
    recommendation: "Proceed to a deterministic Phase 5E probe after narrowing the label to Rule of Law and checking overlap with the active catalog.",
    ...
    evidence: [
      ...
      evidence("The exact 2024 GOV_WGI_RL_EST API query returned 91/91 stable countries.", "konsider_phase5c_batch2/world_bank_coverage_measurements.json", "MEASURED"),
    ],
  },
];
...
const output = {
  phase_id: "5C",
  batch_id: "PHASE5C_BATCH2_2026-07-26",
  ...
  evidence_labels: {
    ...
    ESTIMATED: "Phase 5C analyst judgement; not a completed coverage or licensing audit.",
  ...
  coverage_measurement_file: "konsider_phase5c_batch2/world_bank_coverage_measurements.json",
  decision_summary: {
...
const md = [];
md.push("# Konsider Phase 5C — Batch 2 source-feasibility research", "");
...
fs.writeFileSync(path.join(OUT, "phase5c_batch2.json"), `${JSON.stringify(output, null, 2)}\n`);
fs.writeFileSync(path.join(OUT, "phase5c_batch2.md"), `${md.join("\n").trimEnd()}\n`);
fs.writeFileSync(path.join(OUT, "phase5c_batch2.csv"), `${csvRows.map((row) => row.map(esc).join(",")).join("\n")}\n`);
console.log(`Wrote ${specs.length} criteria, ${shortlist.length} Phase 5E candidates.`);
