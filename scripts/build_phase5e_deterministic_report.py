"""Build and offline-verify the Phase 5E deterministic aggregate report."""
...
OUTPUT = REPORT_ROOT / "phase5e-deterministic-2026-07-26"
...
CANDIDATES = [
    {
        "criterion_id": "C08",
        "definition": "data/research/phase5e/c08-hciplus.json",
        "run_id": "phase5e-2026-07-26-c08-online-v2",
        "superseded_runs": ["phase5e-2026-07-26-c08-online"],
        "phase5c_expected_valid": 88,
        "phase5c_expectation": (
    ...
    {
        "criterion_id": "C11",
        "definition": "data/research/phase5e/c11-ilostat.json",
        "run_id": "phase5e-2026-07-26-c11-online",
        "superseded_runs": [],
        "phase5c_expected_valid": 88,
        "phase5c_expectation": "88/91 current intersection; ATG, GRD and UKR previously absent.",
    ...
    {
        "criterion_id": "C30",
        "definition": "data/research/phase5e/c30-world-bank.json",
        "run_id": "phase5e-2026-07-26-c30-online",
        "superseded_runs": [],
        "phase5c_expected_valid": 91,
        "phase5c_expectation": "91/91 current WDI observations.",
        "recommendation": "PRODUCTION_CANDIDATE",
        "recommendation_rationale": (
    ...
    {
        "criterion_id": "C29",
        "definition": "data/research/phase5e/c29-world-bank.json",
        "run_id": "phase5e-2026-07-26-c29-online",
        "superseded_runs": [],
        "phase5c_expected_valid": 91,
        "phase5c_expectation": (
    ...
    {
        "criterion_id": "C48",
        "definition": "data/research/phase5e/c48-wgi.json",
        "run_id": "phase5e-2026-07-26-c48-online",
        "superseded_runs": [],
        "phase5c_expected_valid": 91,
        "phase5c_expectation": "91/91 for GOV_WGI_PV_EST in 2024.",
        "recommendation": "PRODUCTION_CANDIDATE",
        "recommendation_rationale": (
    ...
    {
        "criterion_id": "C49",
        "definition": "data/research/phase5e/c49-wgi.json",
        "run_id": "phase5e-2026-07-26-c49-online",
        "superseded_runs": [],
        "phase5c_expected_valid": 91,
        "phase5c_expectation": "91/91 for GOV_WGI_RL_EST in 2024.",
        "recommendation": "PRODUCTION_CANDIDATE",
        "recommendation_rationale": (
    ...
    {
        "criterion_id": "C53",
        "definition": "data/research/phase5e/c53-water-sanitation.json",
        "run_id": "phase5e-2026-07-26-c53-online",
        "superseded_runs": [],
        "phase5c_expected_valid": 86,
        "phase5c_expectation": (
        ...
        "recommendation_rationale": (
            ...
            "likely destinations. Retain as a reserve/foundation indicator unless Phase 5F shows "
...
def main() -> int:
        ...
        entries.append(
            {
                **candidate,
                ...
                "phase5c_delta_valid": (
                    summary["valid"] - int(candidate["phase5c_expected_valid"])
                ),
    ...
    aggregate = {
        "schema_version": "phase5e-deterministic-aggregate-1.0",
        "phase_id": "5E",
        "batch_id": "PHASE5E_DETERMINISTIC_2026-07-26",
    ...
    lines = [
        "# Konsider Phase 5E — deterministic measured probes",
        "",
        ...
        "",
        (
            f"All seven probes passed the Phase 5 coverage threshold of 82/91. "
            f"Offline replay passed for {sum(item['passed'] for item in replay_results)}/7."
        ),
        "",
        "| ID | Valid | Missing | Stale | Invalid | Phase 5C delta | Full 91 | Recommendation |",
        "| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |",
    ]
    for entry in entries:
    ...
    for entry in entries:
        ...
        lines.extend(
            [
                ...
                "",
                f"- **Run:** `{entry['run_id']}`",
                f"- **Phase 5C expectation:** {entry['phase5c_expectation']}",
                (
                ...
                (
                    f"- **Comparison:** valid-count delta versus Phase 5C "
                    f"{entry['phase5c_delta_valid']:+d}."
                ),
    ...
    _write_json(
        ...
        {
            "schema_version": "phase5e-deterministic-manifest-1.0",
    ...
    if active_after != active_before:
        raise RuntimeError("Phase 5E aggregate build changed the active release pointer.")
