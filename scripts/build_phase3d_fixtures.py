"""Build small schema-faithful Phase 3D fixtures and nothing else."""
...
OUTPUT = ROOT / "tests" / "fixtures" / "phase3d"
...
def main() -> None:
    ...
    print(f"Wrote Phase 3D fixtures to {OUTPUT}")
