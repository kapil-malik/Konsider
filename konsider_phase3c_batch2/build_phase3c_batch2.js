...
const specs = [
  ...
  },
  {
    ...
    evidence: [
      ...
      evidence("The exact 2022-2024 WDI query returned current observations for 79/91 stable countries; 12 were missing.", "konsider_phase3c_batch2/world_bank_coverage_measurements.json", "MEASURED"),
    ],
  },
  {
    rank: 10,
  ...
  },
  {
    ...
    evidence: [
      ...
      evidence("The stated two-component recency rule produced a measured 91/91 stable-country intersection.", "konsider_phase3c_batch2/world_bank_coverage_measurements.json", "MEASURED"),
    ],
  },
  {
    rank: 14,
    ...
    evidence: [
      ...
      evidence("The exact 2024 GOV_WGI_PV_EST API query returned 91/91 stable countries.", "konsider_phase3c_batch2/world_bank_coverage_measurements.json", "MEASURED"),
    ],
  },
  {
    rank: 15,
    ...
    evidence: [
      ...
      evidence("The exact 2024 GOV_WGI_RL_EST API query returned 91/91 stable countries.", "konsider_phase3c_batch2/world_bank_coverage_measurements.json", "MEASURED"),
    ],
  },
];
...
const output = {
  ...
  coverage_measurement_file: "konsider_phase3c_batch2/world_bank_coverage_measurements.json",
  decision_summary: {
