...
class ValidationTests(TestCase):
    def setUp(self):
        self.artifact = RawArtifact("sha256:a", "source", "url", "url", "2026-01-01T00:00:00+00:00", "json", 1, "a", "v", "p", "path")
    ...
    def test_material_change_is_flagged_for_product_review(self):
        ...
        report = validate_release(
            [self.observation], score_observations([self.observation]), [self.artifact],
            min_criteria=1, min_country_coverage=1, previous_observations=[previous],
        )
