...
evidence inventories, best-common locality, and excluded-country advisory evidence. Phase 5E
exposes the clean transport through strict Pydantic models and authoritative generated OpenAPI.
The JSON schemas remain the native schema-5 domain/release contracts; OpenAPI owns the complete
HTTP contribution, comparison, and country-details surfaces.
