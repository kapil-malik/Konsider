# Konsider Phase 5 — Criteria Expansion and Source Feasibility

## Purpose

Phase 5 expands Konsider from the current five enabled ranking criteria toward a balanced portfolio of approximately 10–15 production-ready criteria.
...
- **5A — Research framework and prioritisation**
  Owner: Web ChatGPT

- **5B — Lightweight screening of all 84 criteria**
  Owner: Desktop ChatGPT Work, or Web ChatGPT

- **5C — Deep source-feasibility research**
  Owner: Desktop ChatGPT Work, in batches of 12–15

- **5D — Generic deterministic feasibility-probe framework**
  Owner: Codex

- **5E — Candidate-specific measured probes**
  Owner: Codex

- **5F — Portfolio selection and guardrail review**
  Owner: Web ChatGPT

- **5G — Production implementation of approved criteria**
  Owner: Codex

- **5H — Closure report and roadmap renumbering**
  Owner: Codex, reviewed by Web ChatGPT

## Recommended order

Run 5A, then 5B. Review both before finalising the first 5C batch. Start 5D only after 5C reveals recurring source and reporting patterns. Run 5E only for approved promising candidates. Complete 5F before any production implementation.

## Roadmap numbering

- New Phase 5: Criteria expansion and source feasibility
- Former deterministic evidence and explanations phase: Phase 6
- Former conversational exploration phase: Phase 7
...
# Phase 5A — Research Framework and Prioritisation
...
Create a Phase 5A framework that:
...
# Phase 5B — Lightweight Screening of All 84 Criteria
...
- completed Phase 5A framework

## Prompt

Perform a lightweight screening of all 84 criteria using the Phase 5A rubric.
...
9. Assign a Phase 5A finding status.
...
# Phase 5C — Deep Source-Feasibility Research
...
Produce detailed criterion sections, a comparison table, a Phase 5E shortlist, open decisions, and Markdown plus machine-readable output.
...
# Phase 5F — Portfolio Selection and Guardrail Review
...
## Inputs
- Phase 5A and 5B reports
- all Phase 5C research reports
- Phase 5E measured reports
- current source, coverage, scoring, and publication documentation

## Prompt

Review all Phase 5 evidence and recommend the strongest balanced portfolio of additional criteria.
...
7. Recommend the Phase 5G implementation order.
...
# Phase 5H — Closure Report and Roadmap Renumbering
...
Close Phase 5 and update forward-looking documentation without rewriting history.
...
3. Update the roadmap:
   - Phase 5: criteria expansion;
   - former deterministic evidence and explanations: Phase 6;
   - former conversational exploration: Phase 7;
...
6. Add a concise Phase 6 recommendation.
