...
Active schema-6.1 overlay `2026-08-07.4` adds three assessment-only Typed Feasibility Checks to
checksum-bound schema-5.2 ranking base `2026-08-07.3`. The base contains 91 countries, 388 selected urban
...
- [Active release report](docs/history/releases/2026-08-07.4.md)
- [Display-metadata-only release workflow](docs/operations/display-metadata-release.md)
