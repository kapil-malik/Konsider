# Konsider Phase 5C — Batch 3 source-feasibility research
...
Proceed to a deterministic Phase 5E probe for **C53**. Treat **C71, C76, C54, C67, C62, C68, C06, C75** as conditional experiments, not approved production criteria. Defer **C70, C78, C42, C57** and reject **C45, C69** under the identified sources. This is the final broad Phase 5C batch; next step is consolidated Phase 5E.
...
1. **C53 — Water quality and sanitation** (DETERMINISTIC): Proceed to Phase 5E with the narrow basic-service definition and explicit missing-country outcomes; keep safely managed services as optional metadata.
2. **C71 — Work-life balance** (CONDITIONAL_EXPERIMENTAL): Run an experimental Phase 5E probe only after renaming to Working-time burden.
3. **C76 — Social protection and welfare support** (CONDITIONAL_EXPERIMENTAL): Run a conditional Phase 5E probe as a national welfare-system reach proxy.
4. **C54 — Food safety and public-health protection** (CONDITIONAL_EXPERIMENTAL): Run an experimental Phase 5E probe; label it Food-safety system capacity.
...
6. **C62 — Digital-government readiness** (CONDITIONAL_EXPERIMENTAL): Experimental only; inspect components in Phase 5E and reject a direct GTMI rank.
7. **C68 — Natural-disaster risk** (CONDITIONAL_EXPERIMENTAL): Conditional Phase 5E probe focused on natural-hazard exposure, subject to exact licence capture.
...
Proceed to Phase 5E with the narrow basic-service definition and explicit missing-country outcomes; keep safely managed services as optional metadata.

## Evidence ledger

- **MEASURED:** Exact WDI API join returned 86/91 fresh intersections. — konsider_phase5c_batch3/world_bank_coverage_measurements.json
- **MEASURED:** The safely managed pair returned 66/91. — konsider_phase5c_batch3/world_bank_coverage_measurements.json
...
Run an experimental Phase 5E probe only after renaming to Working-time burden.
...
- **ESTIMATED:** Stable-91 coverage has not been measured. — Phase 5C Batch 3
...
Run a conditional Phase 5E probe as a national welfare-system reach proxy.
...
- **ESTIMATED:** Stable-91 coverage is publisher-scope based, not measured. — Phase 5C Batch 3
...
Run an experimental Phase 5E probe; label it Food-safety system capacity.
...
- **ESTIMATED:** Stable-91 coverage is not measured. — Phase 5C Batch 3
...
- **ESTIMATED:** Stable-91 country aggregation was not measured. — Phase 5C Batch 3
...
Experimental only; inspect components in Phase 5E and reject a direct GTMI rank.
...
Conditional Phase 5E probe focused on natural-hazard exposure, subject to exact licence capture.
...
- **ESTIMATED:** Exact stable-91 coverage and asset licence were not measured. — Phase 5C Batch 3
...
- **ESTIMATED:** Exact stable-91 coverage and licence were not measured. — Phase 5C Batch 3
...
- **ESTIMATED:** Commercial redistribution terms for the exact v16 archive remain unverified. — Phase 5C Batch 3
...
Defer until the active catalog is consolidated in Phase 5E; revive only if it replaces rather than duplicates multiple criteria.

## Evidence ledger

- **VERIFIED:** ND-GAIN states coverage of 192 UN countries and CC BY 3.0 reuse. — [source](https://gain-new.crc.nd.edu/about/download)
- **ESTIMATED:** Overlap judgement is preliminary. — Phase 5C Batch 3
...
- **ESTIMATED:** Stable-91 coverage and production licence are unverified. — Phase 5C Batch 3
...
- **ESTIMATED:** Stable-91 coverage is inferred from publisher scope, not joined. — Phase 5C Batch 3
...
- **ESTIMATED:** Stable-91 coverage was not joined. — Phase 5C Batch 3
...
Reject for Phase 5E production candidacy unless ILGA grants suitable reuse permission.

## Evidence ledger

- **VERIFIED:** The ILGA report page states CC BY-NC 4.0. — [source](https://ilga.org/laws-on-us-report/)
- **ESTIMATED:** Global coverage was not joined because licence is dispositive. — Phase 5C Batch 3
