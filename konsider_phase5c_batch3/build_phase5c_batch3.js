...
const specs = [
  {
    ...
    blockers: ["CMP_BASIC_NOT_SAFELY_MANAGED", "GRA_LOCAL_VARIATION"], recommendation: "Proceed to Phase 5E with the narrow basic-service definition and explicit missing-country outcomes; keep safely managed services as optional metadata.",
    open: ["Is a high-coverage but low-discrimination basic-service score valuable enough for relocation ranking?"],
    evidence: [ev("Exact WDI API join returned 86/91 fresh intersections.", "konsider_phase5c_batch3/world_bank_coverage_measurements.json", "MEASURED"), ev("The safely managed pair returned 66/91.", "konsider_phase5c_batch3/world_bank_coverage_measurements.json", "MEASURED")],
  },
  {
    ...
    blockers: ["DEF_LABEL_TOO_BROAD", "COV_EXACT_JOIN_REQUIRED"], recommendation: "Run an experimental Phase 5E probe only after renaming to Working-time burden.",
    open: ["Should paid leave be a separate policy/profile feature rather than folded into this score?"],
    evidence: [ev("ILOSTAT lists a November 2025 modelled average-weekly-hours table.", "https://ilostat.ilo.org/topics/working-time/"), ev("Stable-91 coverage has not been measured.", "Phase 5C Batch 3", "ESTIMATED")],
  },
  {
    ...
    blockers: ["PRF_ELIGIBILITY_NOT_MEASURED", "CMP_MODELLED_VALUES"], recommendation: "Run a conditional Phase 5E probe as a national welfare-system reach proxy.",
    open: ["Should imputed observations receive lower confidence or remain unscored?"],
    evidence: [ev("ILO states that model output provides complete 2009-2023 series for 189 countries and territories.", "https://webapps.ilo.org/static/english/reports/flagship/world_social_protection_report_2024-26/Annex.html"), ev("Stable-91 coverage is publisher-scope based, not measured.", "Phase 5C Batch 3", "ESTIMATED")],
  },
  {
    ...
    blockers: ["CMP_SELF_REPORTED", "DEF_CAPACITY_NOT_OUTCOME", "COV_EXACT_JOIN_REQUIRED"], recommendation: "Run an experimental Phase 5E probe; label it Food-safety system capacity.",
    open: ["Is a system-capacity measure sufficiently decision-useful without outcome data?"],
    evidence: [ev("WHO exposes a 2025 SPAR capacity dashboard including Food Safety.", "https://extranet.who.int/e-spar/Home/CapacityScoreDetails"), ev("Stable-91 coverage is not measured.", "Phase 5C Batch 3", "ESTIMATED")],
  },
  {
    ...
    evidence: [ev("CCKP provides global 0.25-degree CMIP6 data through 2100 under CC BY 4.0.", "https://datacatalog.worldbank.org/search/dataset/0042297/climate-change-knowledge-portal-projected-climate-data-cmip6-0-25-degree"), ev("Stable-91 country aggregation was not measured.", "Phase 5C Batch 3", "ESTIMATED")],
  },
  {
    ...
    blockers: ["SCO_PUBLISHER_DISCLAIMS_RANKING", "COV_EXACT_JOIN_REQUIRED"], recommendation: "Experimental only; inspect components in Phase 5E and reject a direct GTMI rank.",
  ...
  },
  {
    ...
    blockers: ["LIC_EXACT_ASSET_UNCLEAR", "RED_SHARED_COMPONENTS", "GRA_LOCAL_VARIATION"], recommendation: "Conditional Phase 5E probe focused on natural-hazard exposure, subject to exact licence capture.",
    open: ["Use exposure-only or the full vulnerability-adjusted risk score?"],
    evidence: [ev("INFORM documents a global composite of hazards/exposure, vulnerability and lack of coping capacity.", "https://drmkc.jrc.ec.europa.eu/inform-index/INFORM-Risk/Methodology"), ev("Exact stable-91 coverage and asset licence were not measured.", "Phase 5C Batch 3", "ESTIMATED")],
  },
  {
    ...
    evidence: [ev("UIS states that its 2025 education release covers more than 200 countries and territories.", "https://uis.unesco.org/en/news/uis-launches-september-2025-global-education-data-release-0"), ev("Exact stable-91 coverage and licence were not measured.", "Phase 5C Batch 3", "ESTIMATED")],
  },
  {
    ...
    evidence: [ev("V-Dem v16 was released in March 2026 and provides 531 indicators and 251 indices.", "https://www.v-dem.net/data/the-v-dem-dataset/"), ev("Commercial redistribution terms for the exact v16 archive remain unverified.", "Phase 5C Batch 3", "ESTIMATED")],
  },
  {
    ...
    blockers: ["RED_SHARED_COMPONENTS", "DEF_COMPOSITE_TOO_BROAD"], recommendation: "Defer until the active catalog is consolidated in Phase 5E; revive only if it replaces rather than duplicates multiple criteria.",
    open: ["Would ND-GAIN replace C67/C68 plus governance inputs, or is hazard-specific scoring preferable?"],
    evidence: [ev("ND-GAIN states coverage of 192 UN countries and CC BY 3.0 reuse.", "https://gain-new.crc.nd.edu/about/download"), ev("Overlap judgement is preliminary.", "Phase 5C Batch 3", "ESTIMATED")],
  },
  {
    ...
    evidence: [ev("WHR 2026 publishes three-year life-evaluation averages based on Gallup World Poll.", "https://www.worldhappiness.report/data-sharing/"), ev("Stable-91 coverage and production licence are unverified.", "Phase 5C Batch 3", "ESTIMATED")],
  },
  {
    ...
    evidence: [ev("WVS Wave 7 reports 77 participating countries/societies and 2017-2021 fieldwork.", "https://www.worldvaluessurvey.org/WVSEventsShow.jsp?ID=413"), ev("Stable-91 coverage is inferred from publisher scope, not joined.", "Phase 5C Batch 3", "ESTIMATED")],
  },
  {
    ...
    evidence: [ev("JMP 2025 reports availability-when-needed estimates for 144 countries/areas.", "https://washdata.org/report/jmp-2025-wash-households"), ev("Stable-91 coverage was not joined.", "Phase 5C Batch 3", "ESTIMATED")],
  },
  {
    ...
    blockers: ["LIC_NONCOMMERCIAL", "SCO_NORMATIVE_WEIGHTS_REQUIRED"], recommendation: "Reject for Phase 5E production candidacy unless ILGA grants suitable reuse permission.",
    open: ["Would ILGA provide a commercial licence or written permission for derived country scores?"],
    evidence: [ev("The ILGA report page states CC BY-NC 4.0.", "https://ilga.org/laws-on-us-report/"), ev("Global coverage was not joined because licence is dispositive.", "Phase 5C Batch 3", "ESTIMATED")],
  },
  {
...
const output = {
  phase_id: "5C", batch_id: "PHASE5C_BATCH3_2026-07-26", evidence_cutoff: "2026-07-26",
  ...
  evidence_labels: {
    ...
    ESTIMATED: "Preliminary Phase 5C judgement; not an exhaustive coverage or licensing audit.",
  },
  ...
  coverage_measurement_file: "konsider_phase5c_batch3/world_bank_coverage_measurements.json",
  decision_summary: {
  ...
  batch_conclusion: "Batch 3 adds one deterministic Phase 5E candidate (C53) and eight conditional experimental candidates. It does not justify a fourth broad Phase 5C batch; consolidate all batches in Phase 5E.",
  criteria: specs,
};

const esc = (v) => /[",\n]/.test(String(v ?? "")) ? `"${String(v ?? "").replaceAll('"', '""')}"` : String(v ?? "");
const md = ["# Konsider Phase 5C — Batch 3 source-feasibility research", "",
  ...
  `Proceed to a deterministic Phase 5E probe for **${output.decision_summary.deterministic_probe.join(", ")}**. Treat **${output.decision_summary.conditional_experimental_probe.join(", ")}** as conditional experiments, not approved production criteria. Defer **${output.decision_summary.deferred.join(", ")}** and reject **${output.decision_summary.rejected.join(", ")}** under the identified sources. This is the final broad Phase 5C batch; next step is consolidated Phase 5E.`, "",
  "## Comparison table", "",
  "| Rank | ID | Criterion | Finding | Granularity | Stable-91 coverage | A/L/C/M | Phase 5E |",
  "| ---: | --- | --- | --- | --- | --- | --- | --- |",
];
...
fs.writeFileSync(path.join(OUT, "phase5c_batch3.json"), `${JSON.stringify(output, null, 2)}\n`);
fs.writeFileSync(path.join(OUT, "phase5c_batch3.md"), `${md.join("\n").trimEnd()}\n`);
fs.writeFileSync(path.join(OUT, "phase5c_batch3.csv"), `${csv.map((r) => r.map(esc).join(",")).join("\n")}\n`);
console.log(`Wrote ${specs.length} criteria and ${shortlist.length} Phase 5E candidates.`);
