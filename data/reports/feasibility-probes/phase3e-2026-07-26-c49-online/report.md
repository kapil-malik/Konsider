# Feasibility probe: C49 — Rule of law

> Research output only. This is not production ingestion and cannot activate a release.

- Run: `phase3e-2026-07-26-c49-online`
- Source candidate: `C49-WGI-RL-2025`
- Publisher/dataset: World Bank — Worldwide Governance Indicators 2025 revision
- Source version: `Recalculated 1996-2024 series; 2024 observation`
- Retrieval/replay time: `2026-07-26T16:41:07.923792+00:00`
...
| ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 91 | 91 | 91 | 91 | 91 | 0 | 0 | 0 | 0 | 0 | 115 |

## Decision gates

- Phase 3 probe threshold (82): **PASS**
- Full stable-universe coverage: **PASS**
- Candidate blockers: CMP_PERCEPTION_BASED, SCO_UNCERTAINTY_REQUIRED, RED_POTENTIAL_GOVERNANCE_OVERLAP
