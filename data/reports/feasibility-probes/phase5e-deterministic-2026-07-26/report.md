...
All seven probes passed the Phase 5 coverage threshold of 82/91. Offline replay passed for 7/7.
...
- **Run:** `phase5e-2026-07-26-c08-online-v2`
- **Phase 5C expectation:** 89 countries with HLO/LAYS, of which 88 had a 2024+ label; BHS and BOL missing.
- **Measured:** 87/91 valid; 2 missing; 1 stale; 1 invalid; 0 parse-failed.
- **Comparison:** valid-count delta versus Phase 5C -1.
...
- **Phase 5C expectation:** 88/91 current intersection; ATG, GRD and UKR previously absent.
- **Measured:** 88/91 valid; 2 missing; 1 stale; 0 invalid; 0 parse-failed.
- **Comparison:** valid-count delta versus Phase 5C +0.
- **Licence:** PASS_CC_BY_4_0_WITH_ATTRIBUTION.
...
- **Phase 5C expectation:** 91/91 current WDI observations.
...
- **Run:** `phase5e-2026-07-26-c29-online`
- **Phase 5C expectation:** 91/91 with at least three 2020-2024 observations in both components and a 2023+ latest year.
- **Measured:** 91/91 valid; 0 missing; 0 stale; 0 invalid; 0 parse-failed.
- **Comparison:** valid-count delta versus Phase 5C +0.
- **Licence:** PASS_CC_BY_4_0_WITH_ATTRIBUTION.
...
- **Run:** `phase5e-2026-07-26-c48-online`
- **Phase 5C expectation:** 91/91 for GOV_WGI_PV_EST in 2024.
- **Measured:** 91/91 valid; 0 missing; 0 stale; 0 invalid; 0 parse-failed.
- **Comparison:** valid-count delta versus Phase 5C +0.
...
- **Run:** `phase5e-2026-07-26-c49-online`
- **Phase 5C expectation:** 91/91 for GOV_WGI_RL_EST in 2024.
- **Measured:** 91/91 valid; 0 missing; 0 stale; 0 invalid; 0 parse-failed.
- **Comparison:** valid-count delta versus Phase 5C +0.
- **Licence:** PASS_CC_BY_4_0_FOR_PUBLISHED_AGGREGATES.
...
- **Run:** `phase5e-2026-07-26-c53-online`
- **Phase 5C expectation:** 86/91 had both basic-water and basic-sanitation observations from 2022-2024.
- **Measured:** 86/91 valid; 2 missing; 0 stale; 3 invalid; 0 parse-failed.
- **Comparison:** valid-count delta versus Phase 5C +0.
- **Licence:** PASS_CC_BY_4_0_WITH_WHO_UNICEF_ATTRIBUTION.
- **Recommendation:** **RESERVE_CANDIDATE** — The exact pair reproduces 86 valid countries and passes the threshold, but basic service access is not water safety or continuity and is highly saturated across many likely destinations. Retain as a reserve/foundation indicator unless Phase 5F shows meaningful ranking discrimination.
