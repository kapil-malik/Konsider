# Konsider Phase 5C — Batch 1 source-feasibility research

Evidence cutoff: **24 July 2026**
Universe: **stable_supported_v1 (91 countries)**
Scope: the first 15-criterion batch recommended by Phase 5B. This is source feasibility research, not production ingestion or a complete legal audit.
...
- **ESTIMATED** is a preliminary Phase 5C judgement.
- **HYPOTHESIS** is an unverified discovery lead.

## Outcome

Three criteria should proceed to deterministic Phase 5E probes: **C30 Existing immigrant share**, **C11 Overall job-market opportunity**, and **C08 School education quality**. Three more justify conditional experimental or recovery probes: **C66 Extreme-weather risk**, **C01 Overall higher-education opportunity**, and **C58 Internet access, speed, and reliability** (only under a narrowed access/penetration definition). Nine should not consume a national Phase 5E probe yet.

## Comparison table

| Rank | ID | Phase 5A status | Natural granularity | Coverage | A/L/C/S | Phase 5E track |
|---:|---|---|---|---|---|---|
| 1 | C11 | PROBE_APPROVED | NATIONAL | 88/91 measured; 88 fresh | A4/L4/C4/S3 | DETERMINISTIC |
| 2 | C32 | DEFERRED_PROFILE_LAYER | PROFILE_ONLY | LOW estimated | A4/L3/C3/S1 | No further 5E work |
| 3 | C33 | DEFERRED_PROFILE_LAYER | PROFILE_ONLY | LOW estimated | A4/L1/C2/S1 | No further 5E work |
| 4 | C17 | DEFERRED | NATIONAL_WITH_CITY_CAVEAT | 76/91 measured; 60 fresh | A4/L4/C3/S3 | No further 5E work |
| 5 | C21 | DEFERRED_PROFILE_LAYER | PROFILE_ONLY | LOW estimated | A4/L4/C4/S2 | No further 5E work |
| 6 | C25 | DEFERRED_CITY_LAYER | CITY_OR_REGIONAL | LOW estimated | A4/L4/C3/S3 | No further 5E work |
| 7 | C50 | DEFERRED | NATIONAL | 91/91 measured; 0 fresh | A4/L4/C4/S4 | No further 5E work |
| 8 | C40 | DEFERRED_CITY_LAYER | CITY_OR_REGIONAL | MEDIUM estimated | A2/L1/C2/S2 | No further 5E work |
...
| 11 | C12 | DEFERRED_CITY_LAYER | CITY_OR_REGIONAL | 66/91 measured; 66 fresh | A4/L4/C3/S2 | No further 5E work |
| 12 | C58 | EXPERIMENTAL_CANDIDATE | NATIONAL_WITH_CITY_CAVEAT | 91/91 measured; 91 fresh | A4/L4/C4/S3 | CONDITIONAL |
| 13 | C56 | DEFERRED | NATIONAL_WITH_CITY_CAVEAT | 0/91 measured; 0 fresh | A4/L4/C4/S2 | No further 5E work |
...
1. **C30 — Existing immigrant share** (deterministic): Proceed to deterministic Phase 5E probe; measured current coverage is 91/91.
2. **C11 — Overall job-market opportunity** (deterministic): Proceed to a deterministic Phase 5E probe. The measured 88/91 intersection clears the 82-country threshold but requires an explicit missing-country policy.
3. **C08 — School education quality** (deterministic): Proceed to deterministic Phase 5E probe; measured field coverage is 89/91 and the source is current, official and reusable.
4. **C66 — Extreme-weather risk** (conditional): Experimental Phase 5E probe only. Coverage is complete, but a Konsider-specific weather subset and weighting need defensibility testing.
...
7. Which city and user-profile universes Phase 5 should support before resuming C17, C21, C25, C32, C33 and C40.
...
- Recommendation: Proceed to a deterministic Phase 5E probe. The measured 88/91 intersection clears the 82-country threshold but requires an explicit missing-country policy.
...
Proceed to a deterministic Phase 5E probe. The measured 88/91 intersection clears the 82-country threshold but requires an explicit missing-country policy.
...
- **ESTIMATED:** No current official global dataset was verified that converts individual skilled-work eligibility into comparable destination scores. [Evidence](Phase 5C source search)
...
- **ESTIMATED:** No authoritative, current, global route-level permanent-residence dataset was verified. [Evidence](Phase 5C source search)
...
- Status: `DEFERRED`
- Recommendation: Defer. Measured recent PPP earnings coverage is 60/91 for 2023+ and 76/91 for 2021+, below the Phase 5A threshold.
- Evidence cutoff: 2026-07-24
...
Defer. Measured recent PPP earnings coverage is 60/91 for 2023+ and 76/91 for 2021+, below the Phase 5A threshold.
...
- Status: `PROBE_APPROVED`
- Recommendation: Proceed to deterministic Phase 5E probe; measured current coverage is 91/91.
- Evidence cutoff: 2026-07-24
...
Proceed to deterministic Phase 5E probe; measured current coverage is 91/91.
...
- Status: `PROBE_APPROVED`
- Recommendation: Proceed to deterministic Phase 5E probe; measured field coverage is 89/91 and the source is current, official and reusable.
- Evidence cutoff: 2026-07-24
- Primary blocker codes: `COV_NOT_FULL_91`
...
Proceed to deterministic Phase 5E probe; measured field coverage is 89/91 and the source is current, official and reusable.
...
- Status: `EXPERIMENTAL_CANDIDATE`
- Recommendation: Experimental Phase 5E probe only. Coverage is complete, but a Konsider-specific weather subset and weighting need defensibility testing.
- Evidence cutoff: 2026-07-24
- Primary blocker codes: none
...
Experimental Phase 5E probe only. Coverage is complete, but a Konsider-specific weather subset and weighting need defensibility testing.
