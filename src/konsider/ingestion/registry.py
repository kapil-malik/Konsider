...
def _wdi(indicator: str, dates: str = "2000:2026", source: int | None = None) -> str:
...
SOURCES = {
    "world_bank_pm25": SourceRegistration(
        source_id="world_bank_pm25", criterion_id="ambient_pm25_population_weighted",
        ...
        download_urls=(_wdi("EN.ATM.PM25.MC.M3", "2018:2026"),),
        access_method="World Bank Indicators API v2, WDI source 2", pagination="none",
        dataset_version="WDI update 2026-07-13", source_version="EN.ATM.PM25.MC.M3@WDI-2026-07-13",
        reference_period="annual, 1990-2023; latest 2023", update_frequency="annual/irregular",
        methodology_url="https://databank.worldbank.org/metadataglossary/world-development-indicators/series/EN.ATM.PM25.MC.M3",
        license_name="Creative Commons Attribution 4.0 International", license_url=_WB_LICENSE,
        ...
        parser="world_bank_pm25", parser_version="world_bank_pm25_v1",
    ...
    "world_bank_uhc": SourceRegistration(
        source_id="world_bank_uhc", criterion_id="uhc_service_coverage_index",
        ...
        download_urls=(_wdi("SH.UHC.SRVS.CV.XD", "2018:2026", source=16),),
        access_method="World Bank Indicators API v2, HNP source 16", pagination="none",
        dataset_version="HNP update 2026-07-01", source_version="SH.UHC.SRVS.CV.XD@HNP-2026-07-01",
        reference_period="annual, latest API value 2021", update_frequency="irregular",
        ...
        parser="world_bank_uhc", parser_version="world_bank_uhc_v1",
        official_or_independent="official_secondary_distribution",
    ...
    "unodc_homicide": SourceRegistration(
        ...
        download_urls=(_wdi("VC.IHR.PSRC.P5", "2000:2026"),),
        access_method="World Bank Indicators API v2, WDI source 2", pagination="none",
        dataset_version="WDI update 2026-07-13", source_version="VC.IHR.PSRC.P5@WDI-2026-07-13",
        reference_period="annual; latest country values 2021-2023", update_frequency="annual/irregular",
        ...
        license_evidence="WDI indicator metadata explicitly labels CC BY-4.0; checked 2026-07-20.",
        parser="world_bank_homicide_current", parser_version="world_bank_homicide_v3",
        official_or_independent="official_secondary_distribution",
    ...
    "world_bank_icp": SourceRegistration(
        ...
        download_urls=(_wdi("PA.NUS.PRVT.PP", "2021:2026"), _wdi("PA.NUS.FCRF", "2021:2026")),
        access_method="World Bank Indicators API v2, WDI source 2", pagination="none",
        ...
        reference_period="latest common country year, currently 2025", update_frequency="annual extrapolation; periodic benchmark",
        ...
        parser="world_bank_icp_current", parser_version="world_bank_icp_v3",
    ...
    "world_bank_wbl": SourceRegistration(
        source_id="world_bank_wbl", criterion_id="women_legal_economic_equality",
        publisher="World Bank Women, Business and the Law", distributor=None,
        canonical_page_url="https://wbl.worldbank.org/en/data/download-data",
        download_urls=("https://wbl.worldbank.org/content/dam/sites/wbl/documents/2026/WBL26_FINAL_ALL.xlsx",),
        access_method="official WBL 2026 XLSX download", pagination="none",
        dataset_version="Women, Business and the Law 2026",
        source_version="WBL26_FINAL_ALL@2026-02-23",
        reference_period="current as of 2025-10-01; report year 2026", update_frequency="annual",
        ...
        parser="world_bank_wbl", parser_version="world_bank_wbl_v1",
        official_or_independent="official",
    ...
    "world_bank_infrastructure": SourceRegistration(
        source_id="world_bank_infrastructure", criterion_id="infrastructure_readiness_composite",
        publisher="World Bank World Development Indicators",
        distributor="World Bank Indicators API; ITU-origin digital components",
        canonical_page_url="https://data.worldbank.org/",
        download_urls=(
            _wdi("IT.NET.USER.ZS", "2018:2026"),
            _wdi("IT.NET.BBND.P2", "2018:2026"),
            _wdi("LP.LPI.INFR.XQ", "2018:2026"),
        ),
        access_method="World Bank Indicators API v2, WDI source 2", pagination="none",
        dataset_version="WDI update 2026-07-13", source_version="INFRA-3@WDI-2026-07-13",
        ...
        parser="world_bank_infrastructure", parser_version="world_bank_infrastructure_v1",
