...
const specs = [
  {
    ...
    evidence: [ev("Exact WDI API join returned 86/91 fresh intersections.", "project-history/phases/phase-3/research/candidate-batch-3/world_bank_coverage_measurements.json", "MEASURED"), ev("The safely managed pair returned 66/91.", "project-history/phases/phase-3/research/candidate-batch-3/world_bank_coverage_measurements.json", "MEASURED")],
  },
  {
...
const output = {
  ...
  coverage_measurement_file: "project-history/phases/phase-3/research/candidate-batch-3/world_bank_coverage_measurements.json",
  decision_summary: {
